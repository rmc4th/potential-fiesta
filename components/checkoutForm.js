...
function CheckoutForm() {
  ...
  async function submitOrder() {
    ...
    console.log("checkoutForm>submitOrder()> process.env.NEXT_PUBLIC_API_URL: ", process.env.NEXT_PUBLIC_API_URL);
    console.log("checkoutForm>submitOrder()> API_URL", API_URL);
